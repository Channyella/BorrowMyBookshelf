            ...
            <div className="container-fluid">
                ...
                <ul className="nav navbar-nav navbar-right">
                    <li className="nav-item">
                        <Link className="nav-link" to="/"><img src="/home.png" alt="Home" /> Home</Link>
                    </li>
                    <li className="nav-item">
                        <Link className="nav-link" to="/profile"><img src="/account.png" alt="Profile" /> Profile</Link>
                    </li>
                    <li className="nav-item">
                        <Link className="nav-link" to="/friends"><img src="/friends.png" alt="Friends" /> Friends</Link>
                    </li>
                    <li className="nav-item">
                        <Link className="nav-link" to="/borrowed"><img src="/being_borrowed.png" alt="Being Borrowed" /> Being Borrowed</Link>
                    </li>
                    <li className="nav-item">
